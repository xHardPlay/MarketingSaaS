...
function syncTextElementFromInputs() {
    if (selectedElement && selectedElement.type === 'text') {
        ...
        selectedElement.width = parseInt(textWidth.value) || 200;
        selectedElement.height = parseInt(textHeight.value) || 60;
...
function updateTextControls(element) {
    if (element && element.type === 'text') {
        ...
        textWidth.value = element.width;
        textHeight.value = element.height;
        ...
        textWidthSlider.value = element.width;
        textHeightSlider.value = element.height;
...
function initializeControls() {
    if (selectedElement && selectedElement.type === 'text') {
        ...
        textWidth.value = selectedElement.width;
        textHeight.value = selectedElement.height;
        ...
        textWidthSlider.value = selectedElement.width;
        textHeightSlider.value = selectedElement.height;
